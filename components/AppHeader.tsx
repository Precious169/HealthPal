        ...
        <header className="flex justify-between items-center mb-10 px-4 md:px-0">
            <div className="flex items-center gap-4">
                {onMenuClick && (
                    <button
                        onClick={onMenuClick}
                        className="md:hidden size-11 flex items-center justify-center bg-white/5 border border-white/10 rounded-lg text-white hover:bg-white/10 transition-all"
                    >
            ...
            <div className="flex items-center gap-2 md:gap-4">
                ...
                <button className="bg-cyan-500 hover:bg-cyan-400 text-white px-4 md:px-6 py-2 md:py-2.5 rounded-lg font-bold text-xs md:text-sm flex items-center gap-2 transition-all shadow-lg shadow-cyan-500/20 whitespace-nowrap">
